 ...
 * Le #define e le enum di drivers/net/wireless/broadcom/b43/b43.h, copiate in
 * blocco: sono autoconsistenti e non tirano dentro tipi kernel. Le struct no,
 * quelle stanno ridotte in stubs/b43.h. I commenti sono rimossi di proposito:
 * un commento multi-riga troncato nella copia si mangia le define successive.
 *
 * Generato, non scritto a mano: rigenerare se cambia il b43.h del tree.
 */
#ifndef _TEST_B43_DEFS_H
#define _TEST_B43_DEFS_H
...
#define B43_SHM_SH_CTSDUR		0x00B8
